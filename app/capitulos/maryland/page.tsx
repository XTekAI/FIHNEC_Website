...
export const metadata: Metadata = {
  title: "Capítulos en Maryland | FIHNEC Zona Noreste",
  description: "Encuentra el capítulo de FIHNEC más cercano en Maryland. Zona Noreste — NJ, PA, VA, MD.",
};

export default function CapitulosMDPage() {
  return (
